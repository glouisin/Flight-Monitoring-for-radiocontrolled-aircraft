...
int displayPage = 0;
String hm = "--", te = "--", lt = "--", lg = "--", at = "--", v = "--", st = "--", h = "--", dp = "--", t_ext = "--"; 
bool newData = false;
  ...
  while (Radio.available()) {
    ...
    if (c == '\n') {
      ...
      if (isValidData(buffer)) {
        ...
        Serial.print("Pression diff (Pa): "); Serial.println(dp);
        Serial.print("Temperature ext(C): "); Serial.println(t_ext);
...
//Attention, laisser les espaces car cela permet de 'nettoyer' l'écran car les caractères ne s'effacent pas automatiquement 
      switch (displayPage) {
        case 0:
          lcd.setCursor(0, 0); lcd.print("HUMI:" + hm + " %        ");
          lcd.setCursor(0, 1); lcd.print("T_IN:" + te + " dC       ");
          break;
        case 1:
        ...
        case 3:
          ...
          break;
        case 4:
          lcd.setCursor(0, 0); lcd.print("T_EXT:" + t_ext + "dC       ");
          lcd.setCursor(0, 1); lcd.print("DIF_P:" + dp + "Pa     ");
          break;
      }
...
bool isValidData(String data) {
  return data.indexOf("Humidite:") != -1 &&
         ...
         data.indexOf("Temp ext:") != -1 &&
         data.indexOf("Pressure:") != -1 &&
         data.indexOf("Lat:") != -1 &&
         data.indexOf("Lng:") != -1 &&
...
void parseData(String data) {
  ...
  dp = extractValue(data, "Pressure:");
  t_ext = extractValue(data, "Temp ext:");
